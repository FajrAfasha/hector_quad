    ...
    def spin(self):
        ...
        while not rospy.is_shutdown():
            try:
                ...
                dz = (self.drone_state[2]- altitude_prev)/dt
                z  = self.drone_state[2]
                
                u_z = Kp_z * (self.z_des - z) - Kd_z * dz
                ...
                # Here!
                dew = (-self.omega_error - (omega_error_prev))/dt
                ew  = -self.omega_error
                
                K_p_w = 0.004
                K_d_w = 0.0002
                
                u_omega_z = Kp_w * (ew) - Kd_w * dew
                
                omega_error_prev = ew

                # TODO: Offset control
                # Here!
                dey = (self.y_error- y_error_prev)/dt
                ey  = self.y_error
                
                K_p_y = 0.015
                K_d_y = 0.0012
                
                u_y = Kp_y * (ey) - Kd_y * dey
